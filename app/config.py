...
#print(base_dir)
#making a class Confif
class Config:
    SECRET_KEY=os.environ.get('SECRET_KEY') or 'you -will-never-guess' #creating a security key for data base
    SQLALCHEMY_DATABASE_URI = 'sqlite:///'+ os.path.join(base_dir, 'employees.db') #creationg a uri for database
